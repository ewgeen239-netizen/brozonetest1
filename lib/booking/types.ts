...
export interface Booking {
  ...
  price: number;
  deposit: number;
  /** jak klient zapłacił — ustawiane przy zamykaniu wizyty */
...
export type CashOperationKind = "income" | "payout" | "deposit" | "tip" | "correction";

export const CASH_KIND_LABEL: Record<CashOperationKind, string> = {
  income: "Wpływ",
  payout: "Wypłata",
...
export interface CashOperation {
  ...
  title: string;
  /** dodatnia = wpływa do kasy, ujemna = wychodzi */
  amount: number;
  bookingId?: string;
  document?: string;
  createdBy: string;
...
export type CashReportStatus = "open" | "closed";

export interface CashReport {
  date: string;
  openingCash: number;
  /** policzone przy zamknięciu dnia */
  countedCash?: number;
...
/** wyliczenia dla jednego dnia — liczone zawsze, nigdy nie trzymane w bazie */
