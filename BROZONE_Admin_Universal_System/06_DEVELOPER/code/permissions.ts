...
/** Ekrany widoczne w menu dla danej roli. */
export function visibleSections(role: Role): string[] {
  switch (role) {
    case "admin":
      return ["dashboard", "rezerwacje", "kalendarz", "klienci", "pracownicy", "uslugi", "ustawienia"];
    case "recepcja":
      return ["dashboard", "rezerwacje", "kalendarz", "klienci", "pracownicy", "uslugi"];
    case "viewer":
